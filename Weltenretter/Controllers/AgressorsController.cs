...
using Weltenretter.Models;

namespace Weltenretter.Controllers
{
    public class AgressorsController : Controller
    {
        ...
        {
              return View(await _context.Agressors.ToListAsync());
        }
        ...
        {
          return _context.Agressors.Any(e => e.AgressorId == id);
        }
    }
}
